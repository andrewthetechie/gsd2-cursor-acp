...
- [ ] Permission handling: respond to `session/request_permission` from Cursor
- [ ] Session lifecycle matches existing GSD-2 provider patterns
- [ ] API key / authentication via `CURSOR_API_KEY` env var or Cursor CLI login
